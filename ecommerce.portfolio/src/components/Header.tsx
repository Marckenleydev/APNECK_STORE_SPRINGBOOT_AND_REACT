...
const Header = () => {
    ...
    <div className="container-xxl">
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          ...
          <a href="tel:+">Call us at +970 (55) 263-5229</a>
          </div>
          <div className="col-md">
            <Link to="" className='links fs-4'><CiMail /></Link>
            <Link to="" className='links fs-4'><BiPhoneCall /></Link>
          </div>
        </div>
    ...
    <div className="row align-items-center m-0">
      ...
      <button className="navbar-toggler d-md-none " type="button" onClick={toggleMenu}>
        ...
        <button className="cart-span fs-3 d-md-none">
          ...
          <CgShoppingCart />
          <b><span>{isLogin ? cart?.totalProduct : 0}</span></b>
          </Link>
      ...
      <div className="col-md-10 row col-lg-10">
        ...
        <div className="row d-flex justify-content-center">
            <div className="col-12 col-md-2 d-none d-md-flex d-lg-flex m-auto">
              ...
              <h4 className='text-capitalize userName'> {user?.data.user.firstName}</h4>
  ...
  <Link onClick={toggleMenu}
    to="/cart"
    className="d-flex align-items-center color-nav me-3 cart-span-one position-relative"  // Add position-relative
  >
